"use client";
import { DuaDhikrSidebarMobile } from "@/components/islamic/dua-dhikr-sidebar-mobile";
...
import { Columns2, Hand, Heart, Moon, Sun, X } from "lucide-react";
        ...
        <div className="flex items-center gap-3">
          <div className="flex gap-3">
            ...
            <div className="flex gap-3">
              ...
              <div>
                <h1 className="text-lg md:text-2xl font-bold">Dua & Dhikr</h1>
                <p className="text-muted-foreground">
                  Supplications and remembrance of Allah from Qur&apos;an and
                  Sunnah
                </p>
              </div>
            </div>
